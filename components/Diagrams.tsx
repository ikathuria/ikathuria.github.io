...
export const FuzzyLogicCurves: React.FC<{ color: string }> = ({ color }) => {
  ...
  return (
    <div className="flex flex-col items-center p-8 bg-white rounded-xl shadow-sm border border-stone-200 my-8 w-full max-w-2xl overflow-hidden">
      ...
      <p className="text-sm text-stone-500 mb-6 text-center">
        Drag the slider to see how "Current Time" maps to fuzzy categories.
      </p>

      <div className="relative w-full h-40 border-b border-stone-300 mb-6">
         {/* Curves */}
         <svg 
         ...
         >
            {/* Morning Curve */}
            <path d="M 0 150 Q 100 150, 166 20 Q 233 150, 333 150" fill="none" stroke="#fbbf24" strokeWidth="2" fillOpacity="0.1" className="fill-amber-100/50"/>
            <text x="166" y="20" textAnchor="middle" fontSize="24" fill="#d97706" fontWeight="bold">Morning</text>

            {/* Afternoon Curve */}
            <path d="M 200 150 Q 350 150, 430 20 Q 510 150, 660 150" fill="none" stroke="#f97316" strokeWidth="2" fillOpacity="0.1" className="fill-orange-100/50"/>
             <text x="430" y="20" textAnchor="middle" fontSize="24" fill="#c2410c" fontWeight="bold">Afternoon</text>

            {/* Evening/Night Curve */}
            <path d="M 500 150 Q 650 150, 750 20 Q 850 150, 1000 150" fill="none" stroke="#4f46e5" strokeWidth="2" fillOpacity="0.1" className="fill-indigo-100/50"/>
            <text x="750" y="20" textAnchor="middle" fontSize="24" fill="#4338ca" fontWeight="bold">Night</text>
         </svg>
         ...
         >
            <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-stone-900 text-white text-xs py-1 px-2 rounded font-mono whitespace-nowrap">
                {Math.floor(time)}:00
            </div>
         </motion.div>
      </div>
